...
class Transaction:
    ...
    def create_output(self,sender_wallet,recipient,land):
        """
        Structure the output data for the transaction
        """
        #if amount > self.output[sender_wallet.address]: # check memmbership
    ...
    def update(self, sender_wallet,recipient,land):
        """
